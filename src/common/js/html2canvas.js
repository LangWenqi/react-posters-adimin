...
// "function"===typeof define&&define.amd?define(function(){return z}):"undefined"!==typeof module&&module.exports?module.exports=z:
        "undefined"!==typeof this&&(this.ES6Promise=z);}).call(window);
    if (window) {
    ...
    ;(function(root) {
        ...
        function mapDomain(string, fn) {
            ...
            var texts = string.split(regexSeparators);
            var encoded = map(texts, fn).join('.');
        ...
        /**
         * Converts a string of Unicode symbols (e.g. a domain name text) to a
...
// https://github.com/niklasvh/html2canvas/issues/503
    ...
    function createWindowClone(ownerDocument, containerDocument, width, height, options, x ,y) {
        textCanvasElements(ownerDocument);
    ...
    function textCanvasElements(ownerDocument) {
